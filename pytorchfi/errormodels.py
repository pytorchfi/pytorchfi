...
class error_models(core.fault_injection):
    ...
    def random_neuron_inj_batched(self, min_val=-1, max_val=1, randLoc=True, randVal=True):
    ...
    def random_inj_per_layer_batched(self, min_val=-1, max_val=1, randLoc=True, randVal=True):
        batch, conv_num, c_rand, h_rand, w_rand, value = ([] for i in range(6))
